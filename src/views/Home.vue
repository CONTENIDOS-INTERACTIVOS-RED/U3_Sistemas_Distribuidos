        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los sistemas bancarios hasta las plataformas de streaming, muchos de los servicios que utilizamos a diario dependen de la operación eficiente de sistemas distribuidos. En esta unidad, conocerá los fundamentos de este tipo de sistemas, en los que múltiples procesos independientes se comunican entre sí para lograr objetivos comunes, sin necesidad de compartir un mismo espacio físico o reloj global. 
              
              p #[b ¡Prepárese para comprender cómo se coordinan sistemas complejos a través de la lógica, la comunicación y la sincronización sin necesidad de un reloj universal!]
